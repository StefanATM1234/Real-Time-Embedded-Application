...
int	valoareTensiune;      //Variabila globala in care va fi salvata tensiunea 
...
/*****************************************************************************************/
		/*trebuie modificat!!*/ AD1CSSLbits.CSS5 = 1;  // Selectam intrarea analogica AN5(RB3) pentru a fi scanata
/******************************************************************************************/
